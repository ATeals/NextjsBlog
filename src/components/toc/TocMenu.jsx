    ...
    return (
        <>
            {onMenu ? (
                ...
                <div
                    onClick={clickHander}
                    className=" cursor-pointer md:hidden z-[0] text-[#eeeff2] fixed bottom-0 right-0 m-[25px] w-[2.5em] h-[2.5em] bg-[#577cf1] rounded-[10px] flex items-center justify-center"
                >
                    📑
                </div>
            )}
