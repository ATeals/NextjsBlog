...
export default ({ post }) => {
    return (
        <div className="transform transition-transform duration-200 hover:scale-105 m-[1.47em] max-w-[650px] md:max-w-[20em] xl:max-w-[343px] 2xl:max-w-[452px]  w-full bg-white shadow-md rounded-lg overflow-hidden px-4 ">
            <Link href={`/posts/${post._raw.flattenedPath}`}>
                ...
                <div className="card-content p-4">
                    ...
                    <p className="card-description text-base text-gray-700 mb-4 line-clamp-3 overflow-hidden overflow-ellipsis">{post.description}</p>
