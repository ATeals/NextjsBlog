---
title: "[개발] 글 시리즈 별로 나누기"
description: "글을 나누는 건 알겠는데 시리즈는 어캐나누지?"
collection: blog
...
[Next.js로 나만의 블로그 만들기 with 정적 생성](https://miryang.dev/blog/build-blog-with-nextjs) - miryang.dev

[bepyan](https://bepyan.github.io/blog)
